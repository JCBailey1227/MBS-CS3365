...
// ✅ Serve moviess.html as homepage BEFORE static middleware
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'moviess.html'));
});
...
const MOVIES_FILE = path.join(__dirname, "movies.xlsx");
